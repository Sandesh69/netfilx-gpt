...
const Header = () => {
  ...
  return (
    <div className="absolute w-full px-8 py-8 bg-gradient-to-b from-black z-10  flex flex-col md:flex-row justify-between">
        ...
        <div className="flex p-4 justify-between">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="py-2   my-2 font-bold text-white cursor-pointer"
            >
              Sign Out
            </button>
          </div>
